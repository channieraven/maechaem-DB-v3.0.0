...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col">
      {/* Hero */}
      <section className="flex flex-col items-center justify-center gap-8 px-6 py-20 text-center bg-gradient-to-b from-green-50 to-white dark:from-green-950/30 dark:to-gray-950">
      ...
      <section className="px-6 py-16 bg-white dark:bg-gray-950">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-10 text-center text-2xl font-semibold text-gray-800 dark:text-gray-100">
            ฟังก์ชันหลักของระบบ
          </h2>
            ...
            {features.map((f) => (
              <Show
                ...
                fallback={
                  <SignInButton mode="modal" forceRedirectUrl={f.external ? "/dashboard" : f.href}>
                    <button className="group flex flex-col gap-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-6 text-left shadow-sm hover:shadow-md hover:border-green-400 dark:hover:border-green-600 transition-all cursor-pointer w-full">
                      <span className="text-3xl">{f.icon}</span>
                      <span className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors">
                        {f.title}
                      </span>
              ...
              >
                <Link
                  ...
                  className="group flex flex-col gap-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-6 shadow-sm hover:shadow-md hover:border-green-400 dark:hover:border-green-600 transition-all"
                >
                  <span className="text-3xl">{f.icon}</span>
                  <span className="font-semibold text-gray-900 dark:text-gray-100 group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors">
                    {f.title}
      ...
      {/* About section */}
      <section className="px-6 py-12 bg-green-50 dark:bg-green-950/20 border-t border-green-100 dark:border-green-900/40">
